...
# url Path For Intities
    ...
    # path('add_intities_save/',IntitiesCreateView.as_view(), name='add_intities_save'),
    path('add_intities_save',IntitiesViews.Add_Intities_Save,name="add_intities_save"),
#     # path('update_intities/<str:intity_id>',IntitiesUpdateView.as_view(),name="update_intities"),
...
#     # path('logoutstate' , IntitiesViews.Logout, name='logoutstate'),
